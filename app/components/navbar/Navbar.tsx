...
export default function Navbar() {
	...
	<>
		...
		<Image onContextMenu={(e) => e.preventDefault()}  src={GifLeagueOfLegends} alt="price shoes logo" width={80} height={70} className="rounded w-[65px] mt-2 rounded-lg  h-[72]  pointer-events-none md:w-30  md:h-30 " />
			<Link href='/' onContextMenu={(e) => e.preventDefault()}  className={`flex w-auto h-full items-center text-5xl md:text-6xl lg:text-7xl text-teal-100 justify-center ${rubik.className} antialiased`}>ARKAL</Link>
