...
export default function Navbar() {
	...
	<>
		...
		<Image onContextMenu={(e) => e.preventDefault()}  src={GifLeagueOfLegends} alt="price shoes logo" width={70} height={60} className="rounded w-24 mt-2 rounded-lg  h-20  pointer-events-none md:w-30  md:h-30 " />
			...
			<Image onContextMenu={(e) => e.preventDefault()}  src={GifLeagueOfLegends} alt="price shoes logo" width={150} height={140} className="rounded w-24 mt-2 rounded-lg  h-20  pointer-events-none md:w-30  md:h-30" />
		</nav>
