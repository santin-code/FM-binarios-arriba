...
export default function Navbar() {
	return(
	<>
		<nav className="w-11/12 mx-auto my-auto mt-4 h-16 bg-black  text-white flex items-center  justify-center md:w-9/12 md:justify-evenly   ">
		<Image onContextMenu={(e) => e.preventDefault()}  src={GifLeagueOfLegends} alt="price shoes logo" width={70} height={60} className="rounded w-28  h-28  pointer-events-none md:w-36  md:h-32 " />
