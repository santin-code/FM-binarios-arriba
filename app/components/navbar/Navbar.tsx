...
export default function Navbar() {
	return(
	<>
		<nav className="w-11/12 mx-auto my-auto mt-4 h-16 bg-black  text-white flex items-center  justify-evenly   ">
		<Image onContextMenu={(e) => e.preventDefault()}  src={Papeleria} alt="price shoes logo" width={70} height={60} className="mr-5 w-12  h-14 rounded pointer-events-none" />
			<div onContextMenu={(e) => e.preventDefault()}  className={`flex w-auto h-full items-center text-4xl md:text-6xl lg:text-7xl text-slate-200 justify-center ${rubik.className} antialiased pointer-events-none`}> Ciber Arkal</div>
