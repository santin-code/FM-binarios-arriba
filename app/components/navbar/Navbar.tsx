...
export default function Navbar() {
	...
	<>
		...
		<Image onContextMenu={(e) => e.preventDefault()}  src={GifLeagueOfLegends} alt="price shoes logo" width={80} height={70} className="rounded w-24 mt-2 rounded-lg  h-20  pointer-events-none md:w-30  md:h-30 " />
